...
/*   Updated: 2016/04/01 06:02:48 by angagnie         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int		default_key_hook(int keycode, void *param)
{
	...
	ft_putnbr(keycode);
	ft_putendl("");
	if (keycode == 43)			w->g.world->node.rot.v.d.s++;
	else if (keycode == 43)		w->g.world->node.rot.v.d.s--;
	else if (keycode == 53)		exit(0);
	else if (keycode == 69)		w->g.world->node.scale *= 1.25;
	else if (keycode == 71)		w->g.world->node.scale *= 0.8;
	else if (keycode == 123)	w->g.world->node.rot++;
